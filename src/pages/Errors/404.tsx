...
export const NotFound = () => {
  return (
    <div
      className={`h-screen bg-no-repeat bg-background flex flex-col items-center justify-center lg:mx-auto`}
    >
      ...
      <div className="sm:mt-0 mt-6 text-center w-full flex flex-col gap-2">
        <h1 className="font-bold font-principal text-amber-500 lg:w-[30%] lg:mx-auto " style={{fontSize: "3rem"}}>404 - Pagina não encontrada!</h1>
